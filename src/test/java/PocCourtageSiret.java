...
public class PocCourtageSiret {
    ...
    public void setUp() throws Exception {
        ...
        videoRecord.startRecording("tt","D:\\projets\\TNR\\video-Courtage");
...
//        driver.findElement(By.xpath("//div[@id='edit_conventions_collectives_chosen']/div/ul/li[contains(text(), 'Je ne sais pas')]")).click();
        ...
        driver.findElement(By.id("edit-field-de-sante-0-inline-entity-form")).click();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        try {

                WebElement popUp = driver.findElement(By.id("drupal-modal--content"));
                System.out.println("Format de SIRET valide !");
                System.out.println("Le pop-up s'affiche !");
                popUp.click();
                ...
                WebElement res = driver.findElement(By.cssSelector("[id^='edit-results-container-']"));
                if (res.getText().contains("Le code postal ne correspond pas au département choisi")) {
                    String error = res.getText();
                    driver.manage().timeouts().implicitlyWait(1000, TimeUnit.SECONDS);
                    Assert.assertEquals("×\n" +
                            "Message d'erreur\n" +
                            "Le code postal ne correspond pas au département choisi.", error);
                    System.out.println("msg erreur  : " + error);
                ...
                String erreur = driver.findElement(By.id("siret-error")).getText();
                System.out.println("Erreur : Le format de SIRET est invalide !"+ erreur);
        }
